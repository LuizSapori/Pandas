...
#keep = Controla como considerar o valor da duplicidade (#Primeiro, último ou o False)
#(#first - primeiro iten como duplicidade, last - segundo iten como duplicidade, False - todos os itens como duplicidade)
